...
class Detail extends React.Component {
	...
	render() {
		...
		const { name, unit, type, type2, date, number, remarks, files } = data;
		return show ? (
...
class Drawer extends React.Component {
	...
	getConditions = () => {
		...
		return { institution, number, type, type2 };
	};
		...
		return (
			<div className="app-container">
				<div className="app-contents">
					...
					<TopTitle title={`文件通知`} canBack />
					<div className="top-searcher">
						<div className="main-input">
							<input onChange={this.onChangeText} placeholder="文件名称" />

			...
			<div className="right-drawer-container">
				...
				<div className="main-container">
					<ul>
						...
						<li>
							<label>开始日期</label>
							<DatePicker ref="date1" placeholder="开始日期" clearable />
						</li>
						<li>
							<label>结束日期</label>
							<DatePicker ref="date2" placeholder="结束日期" clearable />
						</li>
					</ul>
		...
		return (
			<div className="app-container">
				<div className="app-contents">
					...
					<TopTitle title={`降雨量信息`} canBack />
					<div className="top-searcher">
						<div className="main-input">
							<input onChange={this.onChangeText} placeholder="监测地点" />

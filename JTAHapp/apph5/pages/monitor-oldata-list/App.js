...
const renderListItem = ({
	...
	return (
		...
		>
			...
			<p className="detail">
				<span>企业名称：{obj.enterprise}</span>
				<span>检测时间：{obj.date}</span>
			</p>
		</div>
	);
};
...
class Detail extends React.Component {
	...
	render() {
		...
		const { name, enterprise, time, stream, ph, oxygen, AN } = data;
		return show ? (

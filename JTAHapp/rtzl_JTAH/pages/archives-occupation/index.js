...
const pageUri = 'file:///android_asset/h5/archives-occupation/index.html';
...
class Default extends React.Component {
  ...
  onReceive = (event) => {
    ...
    // 当改变查询条件的时候
      ...
      const {searchText, institution} = receivedData;
      let condition = {
      ...
      putupData(this, {
        detail: {
          fieldContents: [
            ...
            {label: '项目名称', content: dataSource.projectName},
            {
              label: '危害预评价评价单位',
              content: dataSource.preEvaluationDepartment,
            },
            {
              label: '危害预评价报告出具时间',
              content: dataSource.reportingTime,
            },
            {label: '防护设施设计批复文号', content: dataSource.approvalNumber},
            {
              label: '防护设施设计批复时间',
              content: dataSource.approvalTime,
            },
            {
              label: '危害控制效果评价评价报告编制单位',
              content: dataSource.reportingDepartment,
            },
            {
              label: '危害控制效果评价评价报告出具时间',
              content: dataSource.reportingTime,
            },
            {
              label: '防护设施验收验收时间',
              content: dataSource.receptionTime,
            },
            {
              label: '当前状态',
              content: transTypeToText3(dataSource.status),
            },
            {
              label: '上传人',
          ...
          let dataArr = data.list
            .map((item) => {
              return {
                ...
                type2: transTypeToText2(item.category),
                dataSource: item,
              };
            })
            .reverse();

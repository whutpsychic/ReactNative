...
const pageUri = 'file:///android_asset/h5/archives-safe/index.html';
      ...
      putupData(this, {
        detail: {
          fieldContents: [
            ...
            {label: '报告出具时间', content: dataSource.issuingTime},
            {label: '设施设计审查批复文号', content: dataSource.approvalNumber},
            {
              label: '控制效果评价报告编制单位',

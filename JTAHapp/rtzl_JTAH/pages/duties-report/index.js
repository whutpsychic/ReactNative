...
const pageUri = 'file:///android_asset/h5/duties-report/index.html';
...
class Default extends React.Component {
  ...
  onReceive = (event) => {
    ...
    // 当改变查询条件的时候
      ...
      const {searchText, institution, year} = receivedData;
      let condition = {
      ...
      putupData(this, {
        detail: {
          fieldContents: [
            ...
            {label: '报告名称', content: dataSource.reportName},
            {
              label: '年度',
              content: dataSource.year,
            },
            {
              label: '上传时间',

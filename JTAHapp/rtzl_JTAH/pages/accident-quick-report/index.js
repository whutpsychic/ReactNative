...
const pageUri = 'file:///android_asset/h5/accident-quick-report/index.html';
          ...
          let dataArr = data.list
            .map((item) => {
              return {
                ...
                date1: item.accidentTime,
                date2: item.createrTime,
                dataSource: item,
              };
            })
            .reverse();
